export class Validation {
    ...
    private readonly validaEmailRegExp: RegExp = new RegExp("^[\\w-\\.]+@([\\w-]+\\.)+[\\w-]{2,4}$");
    private readonly validReleaseYearRegExp: RegExp = new RegExp("^(0|[1-9][0-9]{0,3})$");
    validateCreateBookRequest(bookName: string, author: string, releaseYear: number): boolean{
